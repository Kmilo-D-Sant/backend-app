...
class Usuario(AbstractUser):
    ...
    configuracionActualizada = models.BooleanField("Configuración actual", default= False)
...
class Configuracion(models.Model):
    ...
    limitadosBolaUsuario = models.CharField( max_length=100, blank=True, null=True)
    limitadosBolaBoteUsuario = models.CharField( max_length=100, blank=True, null=True)
    limitadosParlet = models.CharField( max_length=100, blank=True, null=True)
    limitadosParletUsuario = models.CharField( max_length=100, blank=True, null=True)
    limitadosParletBote = models.CharField( max_length=100, blank=True, null=True)
    limitadosParletBoteUsuario = models.CharField( max_length=100, blank=True, null=True)
    limitadosCentena = models.CharField( max_length=100, blank=True, null=True)
    limitadosCentenaUsuario = models.CharField( max_length=100, blank=True, null=True)
    limitadosCentenaBote = models.CharField( max_length=100, blank=True, null=True)
    limitadosCentenaBoteUsuario = models.CharField( max_length=100, blank=True, null=True)
    ...
    noSeJuegaBolaUsuario = models.CharField( max_length=100, blank=True, null=True)
    noSeJuegaBolaBoteUsuario = models.CharField( max_length=100, blank=True, null=True)
    noSeJuegaParlet = models.CharField( max_length=100, blank=True, null=True)
    noSeJuegaParletBote = models.CharField( max_length=100, blank=True, null=True)
    noSeJuegaParletUsuario = models.CharField( max_length=100, blank=True, null=True)
    noSeJuegaParletBoteUsuario = models.CharField( max_length=100, blank=True, null=True)
    noSeJuegaCentena = models.CharField( max_length=100, blank=True, null=True)
    noSeJuegaCentenaBote = models.CharField( max_length=100, blank=True, null=True)
    noSeJuegaCentenaUsuario = models.CharField( max_length=100, blank=True, null=True)
    noSeJuegaCentenaBoteUsuario = models.CharField( max_length=100, blank=True, null=True)
    enviado =models.BooleanField(default=False)
